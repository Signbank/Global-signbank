...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FieldChoice.chinese_name'
        db.add_column(u'dictionary_fieldchoice', 'chinese_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Adding unique constraint on 'Gloss', fields ['annotation_idgloss_en']
        db.create_unique(u'dictionary_gloss', ['annotation_idgloss_en'])

        # Adding unique constraint on 'Gloss', fields ['annotation_idgloss']
        db.create_unique(u'dictionary_gloss', ['annotation_idgloss'])


    def backwards(self, orm):
        # Removing unique constraint on 'Gloss', fields ['annotation_idgloss']
        db.delete_unique(u'dictionary_gloss', ['annotation_idgloss'])

        # Removing unique constraint on 'Gloss', fields ['annotation_idgloss_en']
        db.delete_unique(u'dictionary_gloss', ['annotation_idgloss_en'])

        # Deleting field 'FieldChoice.chinese_name'
        db.delete_column(u'dictionary_fieldchoice', 'chinese_name')
