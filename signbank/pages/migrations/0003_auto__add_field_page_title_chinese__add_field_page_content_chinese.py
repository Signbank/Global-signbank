...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.title_chinese'
        db.add_column(u'pages_page', 'title_chinese',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Page.content_chinese'
        db.add_column(u'pages_page', 'content_chinese',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.title_chinese'
        db.delete_column(u'pages_page', 'title_chinese')

        # Deleting field 'Page.content_chinese'
        db.delete_column(u'pages_page', 'content_chinese')
    ...
    models = {
        ...
        u'pages.page': {
            ...
            'content_chinese': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            ...
            'title_chinese': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
