...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gloss.iconType'
        db.add_column(u'dictionary_gloss', 'iconType',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gloss.lexCatNotes'
        db.add_column(u'dictionary_gloss', 'lexCatNotes',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gloss.iconType'
        db.delete_column(u'dictionary_gloss', 'iconType')

        # Deleting field 'Gloss.lexCatNotes'
        db.delete_column(u'dictionary_gloss', 'lexCatNotes')
