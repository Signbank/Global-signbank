...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gloss.lastUpdated'
        db.add_column(u'dictionary_gloss', 'lastUpdated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 1, 1, 0, 0), auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gloss.lastUpdated'
        db.delete_column(u'dictionary_gloss', 'lastUpdated')
