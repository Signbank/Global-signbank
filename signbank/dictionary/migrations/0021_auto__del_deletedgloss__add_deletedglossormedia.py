...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'DeletedGloss'
        db.delete_table(u'dictionary_deletedgloss')

        # Adding model 'DeletedGlossOrMedia'
        db.create_table(u'dictionary_deletedglossormedia', (
            ...
            ('annotation_idgloss', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('old_pk', self.gf('django.db.models.fields.IntegerField')()),
            ('filename', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('deletion_date', self.gf('django.db.models.fields.DateField')(default=datetime.date.today)),
        ))
        db.send_create_signal(u'dictionary', ['DeletedGlossOrMedia'])


    def backwards(self, orm):
        # Adding model 'DeletedGloss'
        db.create_table(u'dictionary_deletedgloss', (
            ('old_pk', self.gf('django.db.models.fields.IntegerField')()),
            ('annotation_idgloss', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('idgloss', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ...
        db.send_create_signal(u'dictionary', ['DeletedGloss'])

        # Deleting model 'DeletedGlossOrMedia'
        db.delete_table(u'dictionary_deletedglossormedia')
    ...
    models = {
        ...
        u'dictionary.gloss': {
            ...
            'lastUpdated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 1, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
