...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gloss.locPrimLH'
        db.add_column(u'dictionary_gloss', 'locPrimLH',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gloss.locFocSite'
        db.add_column(u'dictionary_gloss', 'locFocSite',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gloss.locFocSiteLH'
        db.add_column(u'dictionary_gloss', 'locFocSiteLH',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gloss.initArtOri'
        db.add_column(u'dictionary_gloss', 'initArtOri',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gloss.finArtOri'
        db.add_column(u'dictionary_gloss', 'finArtOri',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gloss.initArtOriLH'
        db.add_column(u'dictionary_gloss', 'initArtOriLH',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gloss.finArtOriLH'
        db.add_column(u'dictionary_gloss', 'finArtOriLH',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gloss.wordClass'
        db.add_column(u'dictionary_gloss', 'wordClass',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gloss.wordClass2'
        db.add_column(u'dictionary_gloss', 'wordClass2',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gloss.derivHist'
        db.add_column(u'dictionary_gloss', 'derivHist',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gloss.locPrimLH'
        db.delete_column(u'dictionary_gloss', 'locPrimLH')

        # Deleting field 'Gloss.locFocSite'
        db.delete_column(u'dictionary_gloss', 'locFocSite')

        # Deleting field 'Gloss.locFocSiteLH'
        db.delete_column(u'dictionary_gloss', 'locFocSiteLH')

        # Deleting field 'Gloss.initArtOri'
        db.delete_column(u'dictionary_gloss', 'initArtOri')

        # Deleting field 'Gloss.finArtOri'
        db.delete_column(u'dictionary_gloss', 'finArtOri')

        # Deleting field 'Gloss.initArtOriLH'
        db.delete_column(u'dictionary_gloss', 'initArtOriLH')

        # Deleting field 'Gloss.finArtOriLH'
        db.delete_column(u'dictionary_gloss', 'finArtOriLH')

        # Deleting field 'Gloss.wordClass'
        db.delete_column(u'dictionary_gloss', 'wordClass')

        # Deleting field 'Gloss.wordClass2'
        db.delete_column(u'dictionary_gloss', 'wordClass2')

        # Deleting field 'Gloss.derivHist'
        db.delete_column(u'dictionary_gloss', 'derivHist')
