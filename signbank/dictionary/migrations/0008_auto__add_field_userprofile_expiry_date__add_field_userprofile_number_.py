...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.expiry_date'
        db.add_column(u'dictionary_userprofile', 'expiry_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'UserProfile.number_of_logins'
        db.add_column(u'dictionary_userprofile', 'number_of_logins',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.expiry_date'
        db.delete_column(u'dictionary_userprofile', 'expiry_date')

        # Deleting field 'UserProfile.number_of_logins'
        db.delete_column(u'dictionary_userprofile', 'number_of_logins')
    ...
    models = {
        ...
        u'dictionary.userprofile': {
            ...
            'expiry_date': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_used_language': ('django.db.models.fields.CharField', [], {'default': "'en'", 'max_length': '5'}),
            'number_of_logins': ('django.db.models.fields.IntegerField', [], {}),
