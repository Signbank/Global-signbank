...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FieldChoice.dutch_name'
        db.add_column(u'dictionary_fieldchoice', 'dutch_name',
                      self.gf('django.db.models.fields.CharField')(default='Nog niet vertaald', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FieldChoice.dutch_name'
        db.delete_column(u'dictionary_fieldchoice', 'dutch_name')
