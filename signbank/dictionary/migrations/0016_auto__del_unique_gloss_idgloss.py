...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Gloss', fields ['idgloss']
        db.delete_unique(u'dictionary_gloss', ['idgloss'])


    def backwards(self, orm):
        # Adding unique constraint on 'Gloss', fields ['idgloss']
        db.create_unique(u'dictionary_gloss', ['idgloss'])
