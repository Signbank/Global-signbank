...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gloss.domSF'
        db.add_column(u'dictionary_gloss', 'domSF',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gloss.domFlex'
        db.add_column(u'dictionary_gloss', 'domFlex',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gloss.oriChAbd'
        db.add_column(u'dictionary_gloss', 'oriChAbd',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gloss.oriChFlex'
        db.add_column(u'dictionary_gloss', 'oriChFlex',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gloss.domSF'
        db.delete_column(u'dictionary_gloss', 'domSF')

        # Deleting field 'Gloss.domFlex'
        db.delete_column(u'dictionary_gloss', 'domFlex')

        # Deleting field 'Gloss.oriChAbd'
        db.delete_column(u'dictionary_gloss', 'oriChAbd')

        # Deleting field 'Gloss.oriChFlex'
        db.delete_column(u'dictionary_gloss', 'oriChFlex')
