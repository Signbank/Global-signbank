...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'dictionary_deletedgloss', (
            ...
            ('annotation_idgloss_en', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30, blank=True)),
    ...
    models = {
        ...
        u'dictionary.deletedgloss': {
            'Meta': {'object_name': 'DeletedGloss'},
