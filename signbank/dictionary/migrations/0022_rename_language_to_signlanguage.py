...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table(u'dictionary_language', u'dictionary_signlanguage')

        # Changing field 'Dialect.language'
        db.alter_column(u'dictionary_dialect', 'language_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dictionary.SignLanguage']))

    def backwards(self, orm):
        db.rename_table(u'dictionary_signlanguage', u'dictionary_language')

        # Changing field 'Dialect.language'
        db.alter_column(u'dictionary_dialect', 'language_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dictionary.Language']))
    ...
    models = {
        ...
        u'dictionary.deletedglossormedia': {
            'Meta': {'object_name': 'DeletedGlossOrMedia'},
            'annotation_idgloss': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'deletion_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date.today'}),
            ...
            'old_pk': ('django.db.models.fields.IntegerField', [], {})
        },
        u'dictionary.dialect': {
            'Meta': {'ordering': "['language', 'name']", 'object_name': 'Dialect'},
            'description': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dictionary.SignLanguage']"}),
        ...
        u'dictionary.gloss': {
            ...
            'domFlex': ('django.db.models.fields.CharField', [], {'max_length': '5', 'null': 'True', 'blank': 'True'}),
            'domSF': ('django.db.models.fields.CharField', [], {'max_length': '5', 'null': 'True', 'blank': 'True'}),
            ...
            'iconType': ('django.db.models.fields.CharField', [], {'max_length': '5', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'idgloss': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            ...
            'language': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['dictionary.SignLanguage']", 'symmetrical': 'False'}),
            'lastUpdated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'lexCatNotes': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'}),
            ...
            'morphemePart': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['dictionary.Morpheme']", 'symmetrical': 'False', 'blank': 'True'}),
            ...
            'oriChAbd': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'oriChFlex': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'valence': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
        ...
        u'dictionary.morpheme': {
            'Meta': {'ordering': "['idgloss']", 'object_name': 'Morpheme', '_ormbases': [u'dictionary.Gloss']},
            u'gloss_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['dictionary.Gloss']", 'unique': 'True', 'primary_key': 'True'}),
            'mrpType': ('django.db.models.fields.CharField', [], {'max_length': '5', 'null': 'True', 'blank': 'True'})
        },
        ...
        u'dictionary.othermedia': {
            'Meta': {'object_name': 'OtherMedia'},
        ...
        u'dictionary.signlanguage': {
            'Meta': {'ordering': "['name']", 'object_name': 'SignLanguage'},
            'description': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '20'})
        },
