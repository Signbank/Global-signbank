...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Morpheme'
        db.create_table(u'dictionary_morpheme', (
            (u'gloss_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['dictionary.Gloss'], unique=True, primary_key=True)),
            ('mrpType', self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True)),
        ))
