...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeletedGloss.deletion_date'
        db.add_column(u'dictionary_deletedgloss', 'deletion_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.date.today),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DeletedGloss.deletion_date'
        db.delete_column(u'dictionary_deletedgloss', 'deletion_date')
