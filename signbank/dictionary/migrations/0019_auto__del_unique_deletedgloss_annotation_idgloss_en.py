...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'DeletedGloss', fields ['annotation_idgloss_en']
        db.delete_unique(u'dictionary_deletedgloss', ['annotation_idgloss_en'])


    def backwards(self, orm):
        # Adding unique constraint on 'DeletedGloss', fields ['annotation_idgloss_en']
        db.create_unique(u'dictionary_deletedgloss', ['annotation_idgloss_en'])
