...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gloss.alternative_id'
        db.add_column(u'dictionary_gloss', 'alternative_id',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gloss.alternative_id'
        db.delete_column(u'dictionary_gloss', 'alternative_id')
