...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.comments'
        db.add_column(u'dictionary_userprofile', 'comments',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.comments'
        db.delete_column(u'dictionary_userprofile', 'comments')
