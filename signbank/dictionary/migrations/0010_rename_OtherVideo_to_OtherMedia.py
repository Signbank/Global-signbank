...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table(u'dictionary_othervideo',u'dictionary_othermedia')

        # Changing field 'UserProfile.number_of_logins'
        db.alter_column(u'dictionary_userprofile', 'number_of_logins', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):
        db.rename_table(u'dictionary_othermedia',u'dictionary_othervideo')

        # Changing field 'UserProfile.number_of_logins'
        db.alter_column(u'dictionary_userprofile', 'number_of_logins', self.gf('django.db.models.fields.IntegerField')(default=0))
