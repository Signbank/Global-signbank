...
urlpatterns = [
    ...
    re_path(r'^update/add_phonological_variation/(?P<glossid>\d+)$', signbank.dictionary.update.add_phonological_variation, name='add_phonological_variation'),
    ...
    re_path(r'^update/delete_phonological_variation/(?P<variationid>\d+)$', signbank.dictionary.update.delete_phonological_variation, name='delete_phonological_variation'),
