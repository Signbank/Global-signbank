...
urlpatterns = [
    ...
    url(r'^ajax/choice_lists/include_frequencies$', signbank.dictionary.views.choice_lists,{'include_frequencies':True},name='choice_lists'),
    url(r'^ajax/choice_lists/$', signbank.dictionary.views.choice_lists,{'include_frequencies': False}, name='choice_lists'),
