...
urlpatterns = [
    ...
    re_path(r'^ajax/homonyms/(?P<gloss_id>\d+)/$', signbank.dictionary.adminviews.homonyms_ajax_complete, name='homonyms_ajax_complete'),
    ...
    re_path(r'api_update_gloss/(?P<datasetid>\d+)/(?P<glossid>\d+)/(?P<language_code>en|nl|zh-hans)/$',
            signbank.gloss_update.api_update_gloss, name='api_update_gloss'),
    ...
    re_path(r'api_update_gloss_morphology/(?P<datasetid>\d+)/(?P<glossid>\d+)/$',
            signbank.gloss_morphology_update.api_update_gloss_morphology, name='api_update_gloss_morphology'),
    re_path(r'api_update_gloss_morphology/(?P<datasetid>\d+)/(?P<glossid>\d+)/(?P<language_code>en|nl|zh-hans)/$',
            signbank.gloss_morphology_update.api_update_gloss_morphology, name='api_update_gloss_morphology'),
