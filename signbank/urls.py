...
urlpatterns = [
    ...
    url(r'^analysis/search_history/$', SearchHistoryView.as_view(), name='admin_search_history'),
   ...
   # (r'^accounts/login/', 'django.contrib.auth.views.login'),
    ...
    url(r'^datasets/recent_feedback$', signbank.feedback.views.recent_feedback),
    ...
    url(r'^datasets/frequency/(?P<pk>\d+)$', DatasetFrequencyView.as_view(), name='admin_dataset_frequency'),
