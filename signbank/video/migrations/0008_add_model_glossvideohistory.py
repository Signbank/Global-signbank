...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GlossVideoHistory'
        db.create_table(u'video_glossvideohistory', (
            ...
            ('uploadfile', self.gf('django.db.models.fields.TextField')()),
            ('gloss', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dictionary.Gloss'])),
        ))
        db.send_create_signal(u'video', ['GlossVideoHistory'])


    def backwards(self, orm):
        # Deleting model 'GlossVideoHistory'
        db.delete_table(u'video_glossvideohistory')
