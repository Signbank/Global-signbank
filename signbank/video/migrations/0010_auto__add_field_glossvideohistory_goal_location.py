...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GlossVideoHistory.goal_location'
        db.add_column(u'video_glossvideohistory', 'goal_location',
                      self.gf('django.db.models.fields.TextField')(default='(not specified)'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GlossVideoHistory.goal_location'
        db.delete_column(u'video_glossvideohistory', 'goal_location')
    ...
    models = {
        ...
        u'video.glossvideohistory': {
            ...
            'actor': ('django.db.models.fields.related.ManyToManyField', [], {'default': u"orm['auth.User']", 'to': u"orm['auth.User']", 'symmetrical': 'False'}),
            'datestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 15, 0, 0)'}),
            'gloss': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dictionary.Gloss']"}),
