...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GlossVideoHistory.user'
        db.delete_column(u'video_glossvideohistory', 'user')
    ...
    def backwards(self, orm):
        # Adding field 'GlossVideoHistory.user'
        db.add_column(u'video_glossvideohistory', 'user',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2016, 6, 15, 0, 0), max_length=20),
                      keep_default=False)
    ...
    models = {
        ...
        u'video.glossvideohistory': {
            'Meta': {'object_name': 'GlossVideoHistory'},
            'action': ('django.db.models.fields.CharField', [], {'max_length': '6'}),
            'actor': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['auth.User']", 'null': 'True', 'symmetrical': 'False'}),
            'datestamp': ('django.db.models.fields.DateTimeField', [], {}),
            'gloss': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dictionary.Gloss']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'uploadfile': ('django.db.models.fields.TextField', [], {})
        },
        u'video.video': {
