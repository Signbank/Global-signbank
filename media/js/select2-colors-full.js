            ...
            return function() {
                ...
                return b.Extend(c, b.Observable), c.prototype.render = function() {
                    ...
                    var d = this.options.get("templateResult"),
                        ...
                        f = d(b, c);
                        var g = document.createRange().createContextualFragment(f);
                        if (g.firstElementChild) {
                            c.style.backgroundColor = g.firstElementChild.style.backgroundColor;
                        } else {
                            c.style.backgroundColor = "rgb(255, 255, 255)";
                        };
                        var h = g.textContent;
                    null == h ? c.style.display = "none" : "string" == typeof h ? c.innerHTML = e(h) : a(c).append(h)
                }, c
                ...
                return D.prototype.apply = function(l) {
                    ...
                    this.defaults = {
                        ...
                        templateResult: function(a) {
                            var color_text = a.text;
                            if (a.element) {
                                color_text = "<span style='background-color:"+a.element.style.backgroundColor+"'>"+a.text+"</span>"
                            };
                            return color_text
                        },
